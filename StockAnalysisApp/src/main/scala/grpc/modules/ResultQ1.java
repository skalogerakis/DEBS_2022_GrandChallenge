...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              indicators_ = new java.util.ArrayList<grpc.modules.Indicator>();
              mutable_bitField0_ |= 0x00000001;
            }
            indicators_.add(
                input.readMessage(grpc.modules.Indicator.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return grpc.modules.ChallengerProto.internal_static_Challenger_ResultQ1_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return grpc.modules.ChallengerProto.internal_static_Challenger_ResultQ1_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            grpc.modules.ResultQ1.class, grpc.modules.ResultQ1.Builder.class);
  }
  ...
  private java.util.List<grpc.modules.Indicator> indicators_;
  /**
   * <code>repeated .Challenger.Indicator indicators = 3;</code>
   */
  public java.util.List<grpc.modules.Indicator> getIndicatorsList() {
    return indicators_;
  }
  /**
   * <code>repeated .Challenger.Indicator indicators = 3;</code>
   */
  public java.util.List<? extends grpc.modules.IndicatorOrBuilder> 
   ...
   * <code>repeated .Challenger.Indicator indicators = 3;</code>
   */
  public grpc.modules.Indicator getIndicators(int index) {
    return indicators_.get(index);
  }
  /**
   * <code>repeated .Challenger.Indicator indicators = 3;</code>
   */
  public grpc.modules.IndicatorOrBuilder getIndicatorsOrBuilder(
      int index) {
    return indicators_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof grpc.modules.ResultQ1)) {
      return super.equals(obj);
    }
    grpc.modules.ResultQ1 other = (grpc.modules.ResultQ1) obj;
  ...
  public static grpc.modules.ResultQ1 parseFrom(
  ...
  public static grpc.modules.ResultQ1 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static grpc.modules.ResultQ1 parseFrom(
  ...
  public static grpc.modules.ResultQ1 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static grpc.modules.ResultQ1 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static grpc.modules.ResultQ1 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(grpc.modules.ResultQ1 prototype) {
  ...
  public static final class Builder extends
      ...
      grpc.modules.ResultQ1OrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return grpc.modules.ChallengerProto.internal_static_Challenger_ResultQ1_descriptor;
    }
    ...
    // Construct using grpc.modules.ResultQ1.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public grpc.modules.ResultQ1 getDefaultInstanceForType() {
      return grpc.modules.ResultQ1.getDefaultInstance();
    }

    @java.lang.Override
    public grpc.modules.ResultQ1 build() {
      grpc.modules.ResultQ1 result = buildPartial();
    ...
    @java.lang.Override
    public grpc.modules.ResultQ1 buildPartial() {
      grpc.modules.ResultQ1 result = new grpc.modules.ResultQ1(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof grpc.modules.ResultQ1) {
        return mergeFrom((grpc.modules.ResultQ1)other);
      } else {
    ...
    public Builder mergeFrom(grpc.modules.ResultQ1 other) {
      if (other == grpc.modules.ResultQ1.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      grpc.modules.ResultQ1 parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (grpc.modules.ResultQ1) e.getUnfinishedMessage();
    ...
    private void ensureIndicatorsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        indicators_ = new java.util.ArrayList<grpc.modules.Indicator>(indicators_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        grpc.modules.Indicator, grpc.modules.Indicator.Builder, grpc.modules.IndicatorOrBuilder> indicatorsBuilder_;
    ...
    public Builder setIndicators(
        int index, grpc.modules.Indicator value) {
      if (indicatorsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setIndicators(
        int index, grpc.modules.Indicator.Builder builderForValue) {
      if (indicatorsBuilder_ == null) {
        ensureIndicatorsIsMutable();
     ...
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public Builder addIndicators(grpc.modules.Indicator value) {
      if (indicatorsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addIndicators(
        grpc.modules.Indicator.Builder builderForValue) {
      if (indicatorsBuilder_ == null) {
        ensureIndicatorsIsMutable();
    ...
    public Builder addAllIndicators(
        java.lang.Iterable<? extends grpc.modules.Indicator> values) {
      if (indicatorsBuilder_ == null) {
        ensureIndicatorsIsMutable();
     ...
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public grpc.modules.Indicator.Builder getIndicatorsBuilder(
        int index) {
     ...
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public grpc.modules.Indicator.Builder addIndicatorsBuilder() {
      return getIndicatorsFieldBuilder().addBuilder(
          grpc.modules.Indicator.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public grpc.modules.Indicator.Builder addIndicatorsBuilder(
        int index) {
      return getIndicatorsFieldBuilder().addBuilder(
          index, grpc.modules.Indicator.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public java.util.List<grpc.modules.Indicator.Builder> 
         getIndicatorsBuilderList() {
      return getIndicatorsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        grpc.modules.Indicator, grpc.modules.Indicator.Builder, grpc.modules.IndicatorOrBuilder> 
        getIndicatorsFieldBuilder() {
      if (indicatorsBuilder_ == null) {
  ...
  private static final grpc.modules.ResultQ1 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new grpc.modules.ResultQ1();
  }

  public static grpc.modules.ResultQ1 getDefaultInstance() {
