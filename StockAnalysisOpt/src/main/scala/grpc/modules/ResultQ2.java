...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              crossoverEvents_ = new java.util.ArrayList<grpc.modules.CrossoverEvent>();
              mutable_bitField0_ |= 0x00000001;
            }
            crossoverEvents_.add(
                input.readMessage(grpc.modules.CrossoverEvent.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return grpc.modules.ChallengerProto.internal_static_Challenger_ResultQ2_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return grpc.modules.ChallengerProto.internal_static_Challenger_ResultQ2_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            grpc.modules.ResultQ2.class, grpc.modules.ResultQ2.Builder.class);
  }
  ...
  private java.util.List<grpc.modules.CrossoverEvent> crossoverEvents_;
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public java.util.List<grpc.modules.CrossoverEvent> getCrossoverEventsList() {
    return crossoverEvents_;
  }
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public java.util.List<? extends grpc.modules.CrossoverEventOrBuilder> 
   ...
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public grpc.modules.CrossoverEvent getCrossoverEvents(int index) {
    return crossoverEvents_.get(index);
  }
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  public grpc.modules.CrossoverEventOrBuilder getCrossoverEventsOrBuilder(
      int index) {
    return crossoverEvents_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof grpc.modules.ResultQ2)) {
      return super.equals(obj);
    }
    grpc.modules.ResultQ2 other = (grpc.modules.ResultQ2) obj;
  ...
  public static grpc.modules.ResultQ2 parseFrom(
  ...
  public static grpc.modules.ResultQ2 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static grpc.modules.ResultQ2 parseFrom(
  ...
  public static grpc.modules.ResultQ2 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static grpc.modules.ResultQ2 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static grpc.modules.ResultQ2 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(grpc.modules.ResultQ2 prototype) {
  ...
  public static final class Builder extends
      ...
      grpc.modules.ResultQ2OrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return grpc.modules.ChallengerProto.internal_static_Challenger_ResultQ2_descriptor;
    }
    ...
    // Construct using grpc.modules.ResultQ2.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public grpc.modules.ResultQ2 getDefaultInstanceForType() {
      return grpc.modules.ResultQ2.getDefaultInstance();
    }

    @java.lang.Override
    public grpc.modules.ResultQ2 build() {
      grpc.modules.ResultQ2 result = buildPartial();
    ...
    @java.lang.Override
    public grpc.modules.ResultQ2 buildPartial() {
      grpc.modules.ResultQ2 result = new grpc.modules.ResultQ2(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof grpc.modules.ResultQ2) {
        return mergeFrom((grpc.modules.ResultQ2)other);
      } else {
    ...
    public Builder mergeFrom(grpc.modules.ResultQ2 other) {
      if (other == grpc.modules.ResultQ2.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      grpc.modules.ResultQ2 parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (grpc.modules.ResultQ2) e.getUnfinishedMessage();
    ...
    private void ensureCrossoverEventsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        crossoverEvents_ = new java.util.ArrayList<grpc.modules.CrossoverEvent>(crossoverEvents_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        grpc.modules.CrossoverEvent, grpc.modules.CrossoverEvent.Builder, grpc.modules.CrossoverEventOrBuilder> crossoverEventsBuilder_;
    ...
    public Builder setCrossoverEvents(
        int index, grpc.modules.CrossoverEvent value) {
      if (crossoverEventsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setCrossoverEvents(
        int index, grpc.modules.CrossoverEvent.Builder builderForValue) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public Builder addCrossoverEvents(grpc.modules.CrossoverEvent value) {
      if (crossoverEventsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addCrossoverEvents(
        grpc.modules.CrossoverEvent.Builder builderForValue) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
    ...
    public Builder addAllCrossoverEvents(
        java.lang.Iterable<? extends grpc.modules.CrossoverEvent> values) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public grpc.modules.CrossoverEvent.Builder getCrossoverEventsBuilder(
        int index) {
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public grpc.modules.CrossoverEvent.Builder addCrossoverEventsBuilder() {
      return getCrossoverEventsFieldBuilder().addBuilder(
          grpc.modules.CrossoverEvent.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public grpc.modules.CrossoverEvent.Builder addCrossoverEventsBuilder(
        int index) {
      return getCrossoverEventsFieldBuilder().addBuilder(
          index, grpc.modules.CrossoverEvent.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public java.util.List<grpc.modules.CrossoverEvent.Builder> 
         getCrossoverEventsBuilderList() {
      return getCrossoverEventsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        grpc.modules.CrossoverEvent, grpc.modules.CrossoverEvent.Builder, grpc.modules.CrossoverEventOrBuilder> 
        getCrossoverEventsFieldBuilder() {
      if (crossoverEventsBuilder_ == null) {
  ...
  private static final grpc.modules.ResultQ2 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new grpc.modules.ResultQ2();
  }

  public static grpc.modules.ResultQ2 getDefaultInstance() {
